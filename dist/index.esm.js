...
const LeetcodecalendarComponent = ({ username, graph = "default" }) => {
    ...
    if (isError)
        return jsxs("div", { children: ["Error: ", error?.message] });
    return (jsx("div", { className: "bg-[#101828] text-white p-4", children: jsxs("div", { className: "flex flex-col items-center", children: [jsx("h2", { className: "text-lg font-semibold mb-2", children: graph === "yearly" ? "Last Year's LeetCode Submissions" : "LeetCode Submissions" }), filteredData.length > 0 ? (jsx(ActivityCalendar, { data: filteredData, labels: {
                    ...
                    } })) : (jsx("p", { children: "No data available for the given username." }))] }) }));
};
